...
def main() -> None:
    ...
    page_hero("Consulta de asistencias", "Filtra por fecha, docente y estatus con una vista moderna y legible.")
    ...
    with st.form("filters_form"):
        ...
        with st.spinner("Cargando docentes..."):
            ...
            with get_session() as session:
                ...
                docentes_records = [{"id": d.id, "nombre": f"{d.nombre} {d.apellidos}"} for d in docentes]
        ...
        estatus = c4.selectbox("Estatus", estatus_options)
